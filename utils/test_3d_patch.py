...
def var_all_case_Pan(model, num_classes, patch_size=(112, 112, 80), stride_xy=18, stride_z=4):
...
def var_all_case_kits(model, num_classes, patch_size=(112, 112, 80), stride_xy=18, stride_z=4):
...
def var_all_case_lits(model, num_classes, patch_size, stride_xy, stride_z):
